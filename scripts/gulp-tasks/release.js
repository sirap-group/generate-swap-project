...
gulp.task('release:prerelease', done => {
  runSequence('gitIsRepoClean', 'build', 'bump:prerelease', 'getPackageTag', 'gitCommitPackage', 'gitTag', 'publish', 'gitPush', done)
})
...
gulp.task('release:patch', done => {
  runSequence('gitIsRepoClean', 'build', 'bump:patch', 'getPackageTag', 'gitCommitPackage', 'gitTag', 'publish', 'gitPush', done)
})
...
gulp.task('release:minor', done => {
  runSequence('gitIsRepoClean', 'build', 'bump:minor', 'getPackageTag', 'gitCommitPackage', 'gitTag', 'publish', 'gitPush', done)
})
...
gulp.task('release:major', done => {
  runSequence('gitIsRepoClean', 'build', 'bump:major', 'getPackageTag', 'gitCommitPackage', 'gitTag', 'publish', 'gitPush', done)
})
